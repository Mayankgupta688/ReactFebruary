export default function EmplyeeDetails(props) {
    debugger;

    function callDeleteFunction(event) {
    ...
    return (
        <div className="card" style={{width: "18rem", display: "inline-block", margin: "15px"}}>
            ...
            <div className="card-body">
                ...
                <input name={props.name} id={props.id} type="button" value="Delete" onClick={callDeleteFunction} className="btn btn-primary" />
            </div>
        </div>
    )
}